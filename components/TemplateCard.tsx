...
export default function TemplateCard(template:TEMPLATE){
    return(
        <Link href={`/dashboard/content/${template.slug}`} className="p-5 shadow-sm rounded-lg bg-white flex flex-col justify-center gap-3 border border-slate-700 cursor-pointer hover:shadow-xl hover:scale-105 transition-all">
